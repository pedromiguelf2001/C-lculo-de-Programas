...
a91680 & Bruno Jardim 
\\
a91643 & Eduardo Freitas
\\
a91699 & Pedro Fernandes
\end{tabular}
\end{center}
...
alice = either id (umax . (bob><bob)) . outLTree


bob :: Ord c => LTree c -> c    
bob = either id (umin . (alice><alice)) . outLTree
...
propagate f = cataList (g f) where
   ...
   g2 f (a,b) = do {t <- b; h <- f a ; return (h:t)}
\end{code}
