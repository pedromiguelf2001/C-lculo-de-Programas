...
\begin{eqnarray*}
\start
     \ensuremath{\conj{\Varid{qd}}{\conj{\Varid{rd}}{\Varid{cd}}}}
%
\just\equiv{ Fokkinga }
%               
    \ensuremath{\begin{lcbr}\Varid{qd}\comp \mathbf{in}\mathrel{=}\Varid{f}\comp \Conid{F}\;\conj{\Varid{qd}}{\conj{\Varid{rd}}{\Varid{cd}}}\\\Varid{rd}\comp \mathbf{in}\mathrel{=}\Varid{g}\comp \Conid{F}\;\conj{\Varid{qd}}{\conj{\Varid{rd}}{\Varid{cd}}}\\\Varid{cd}\comp \mathbf{in}\mathrel{=}\Varid{h}\comp \Conid{F}\;\conj{\Varid{qd}}{\conj{\Varid{rd}}{\Varid{cd}}}\end{lcbr}}
%
\just\equiv{ Seja: }
%
\ensuremath{\Varid{cond}\mathrel{=}(\mathrm{0}\equiv )\comp \p2\comp \p2}
%
\just\equiv{Definição de in; Def - x}
    \ensuremath{\begin{lcbr}\begin{lcbr}\Varid{qd}\;\mathrm{0}\mathrel{=}\mathrm{0}\\\Varid{qd}\;\Varid{n}\mathrel{=}(\Varid{cond}\to \succ \comp \p1,\p1)\comp (\Varid{qd}\;\Varid{n},(\Varid{rd}\;\Varid{n},\Varid{cd}\;\Varid{n}))\end{lcbr}\\\begin{lcbr}\Varid{rd}\;\mathrm{0}\mathrel{=}\mathrm{0}\\\Varid{rd}\;\Varid{n}\mathrel{=}(\Varid{cond}\to \mathrm{0},\succ \comp \p1\comp \p2)\comp (\Varid{qd}\;\Varid{n},(\Varid{rd}\;\Varid{n},\Varid{cd}\;\Varid{n}))\end{lcbr}\\\begin{lcbr}\Varid{cd}\;\mathrm{0}\mathrel{=}\Varid{d}\\\Varid{cd}\;\Varid{n}\mathrel{=}(\Varid{cond}\to \Varid{d},\Varid{pred}\comp \p2\comp \p2)\comp (\Varid{qd}\;\Varid{n},(\Varid{rd}\;\Varid{n},\Varid{cd}\;\Varid{n}))\end{lcbr}\end{lcbr}}
\just\equiv {Funtor para naturais; Definição de in para naturais; Universal-cata}
    \ensuremath{\cata{\conj{\alt{\mathrm{0}}{\Varid{cond}\to \succ \comp \p1,\p1}}{\conj{\alt{\mathrm{0}}{\Varid{cond}\to \mathrm{0},\succ \comp \p1\comp \p2}}{\alt{\Varid{d}}{(\Varid{cond}\to \Varid{d},\Varid{pred}\comp \p2\comp \p2)}}}}}

\just\equiv {Definição de for}
    \ensuremath{\for{\conj{(\Varid{cond}\to \succ \comp \p1,\p1)}{\conj{(\Varid{cond}\to \mathrm{0},\succ \comp \p1\comp \p2)}{(\Varid{cond}\to \Varid{d},\Varid{pred}\comp \p2\comp \p2)}}}\ {(\mathrm{0},\mathrm{0},\Varid{d})}}
\qed
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{umin}\mathbin{::}\Conid{Ord}\;\Varid{a}\Rightarrow (\Varid{a},\Varid{a})\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{umin}\mathrel{=}\uncurry{\Varid{min}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{alice}\mathbin{::}\Conid{Ord}\;\Varid{c}\Rightarrow {\LTree}\;\Varid{c}\to \Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{alice}\mathrel{=}\alt{\Varid{id}}{\Varid{umax}\comp (\Varid{bob}\times\Varid{bob})}\comp \mathsf{out}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bob}\mathbin{::}\Conid{Ord}\;\Varid{c}\Rightarrow {\LTree}\;\Varid{c}\to \Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{bob}\mathrel{=}\alt{\Varid{id}}{\Varid{umin}\comp (\Varid{alice}\times\Varid{alice})}\comp \mathsf{out}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{both}\mathbin{::}\Conid{Ord}\;\Varid{d}\Rightarrow {\LTree}\;\Varid{d}\to (\Varid{d},\Varid{d}){}\<[E]%
\\
\>[B]{}\Varid{both}\mathrel{=}(\Varid{alice}\times\Varid{bob})\comp \Varid{diag}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{alice2}\mathbin{::}\Conid{Ord}\;\Varid{c}\Rightarrow {\LTree}\;\Varid{c}\to \Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{alice2}\mathrel{=}\p1\comp \Varid{both2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{bob2}\mathbin{::}\Conid{Ord}\;\Varid{c}\Rightarrow {\LTree}\;\Varid{c}\to \Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{bob2}\mathrel{=}\p2\comp \Varid{both2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{both2}\mathbin{::}{}\<[11]%
\>[11]{}\Conid{Ord}\;\Varid{d}\Rightarrow {\LTree}\;\Varid{d}\to (\Varid{d},\Varid{d}){}\<[E]%
\\
\>[B]{}\Varid{both2}\mathrel{=}\llparenthesis\, \alt{\conj{\Varid{id}}{\Varid{id}}}{\conj{\Varid{umax}\comp (\p2\times\p2)}{\Varid{umin}\comp (\p1\times\p1)}}\,\rrparenthesis{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{both3}\mathbin{::}{}\<[11]%
\>[11]{}\Conid{Ord}\;\Varid{d}\Rightarrow {\LTree}\;\Varid{d}\to (\Varid{d},\Varid{d}){}\<[E]%
\\
\>[B]{}\Varid{both3}\mathrel{=}\llparenthesis\, \conj{\alt{\Varid{id}}{{}\<[39]%
\>[39]{}\Varid{umax}\comp (\p2\times\p2)}}{\alt{\Varid{id}}{\Varid{umin}\comp (\p1\times\p1)}}\,\rrparenthesis{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{l}\mathrel{=}\Varid{s}\div \mathrm{2}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{t1}\mathrel{=}(((\Varid{x},\Varid{y}){}\<[27]%
\>[27]{},\Varid{l}),\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{t2}\mathrel{=}(((\Varid{x}\mathbin{+}\Varid{l},\Varid{y}),\Varid{l}),\Varid{n}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\Varid{t3}\mathrel{=}(((\Varid{x},\Varid{y}\mathbin{+}\Varid{l}),\Varid{l}),\Varid{n}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}g_2 \;\Varid{f}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{t}\leftarrow \Varid{b};\Varid{h}\leftarrow \Varid{f}\;\Varid{a};\Varid{return}\;(\Varid{h}\mathbin{:}\Varid{t})\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}g_2 \;\Varid{f}\;(\Varid{a},\Varid{b})\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{t}\leftarrow \Varid{b};\Varid{h}\leftarrow \Varid{f}\;(\Varid{a},\Varid{a},\Varid{a});{}\<[47]%
\>[47]{}\Varid{return}\;(v_3 \;\Varid{h}\mathbin{:}\Varid{t})\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{bflip3}\;(\Varid{a},\Varid{b},\Varid{c})\mathrel{=}\mathbf{do}\;\{\mskip1.5mu \Varid{na}\leftarrow \Varid{bflip}\;\Varid{a};\Varid{nb}\leftarrow \Varid{bflip}\;\Varid{b};\Varid{nc}\leftarrow \Varid{bflip}\;\Varid{c};\Varid{return}\;(\Varid{na},\Varid{nb},\Varid{nc})\mskip1.5mu\}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
